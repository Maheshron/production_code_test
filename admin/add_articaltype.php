...
if(isset($_REQUEST['submit'])){
 $article_name = $_POST['addarticle'];
 $aresult =  $user->add_articletype($article_name);
  if($aresult){
             echo '<script> setTimeout(function () { swal("Success ! ","ArticalType Added Successfully","success");}, 2000); </script>';
...
<?php include("sidebar.php"); ?>
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Add Artical Type</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0)">Artical Type</a></li>
        <li class="breadcrumb-item active">Add Artical Type</li>
      </ol>
        ...
        <div class="panel-body container-fluid">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Artical type</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="addarticle" autocomplete="off" required>
                </div>
              
                    
                <div class="form-group col-md-12 text-center">
                      <button type="submit" name="submit" class="btn btn-primary">Add Artical Type</button>
                </div>
            </div>
        </div>
      </div>
