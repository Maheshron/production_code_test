...
if(isset($_REQUEST['submit'])){
  extract($_REQUEST);
   ...
   if(empty($indexing_image)){

    $indexing_image=$user->index_logo;
    
    }
              move_uploaded_file($indexing_image,"../edelweiss/upload/indexes/$indexing_image");
              $result = $user->update_indexing($id,$indexing_image,$index_link,$index_logo_description,$index_title);
    if($result){
     echo '<script> alert(updated); </script>';
      echo '<script> setTimeout(function () { swal("Success ! ","Artical Added Successfully","success");}, 2000); </script>';
          ...
          <div class="row row-lg">
            ...
            <div class="row">
                <!-- <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="index_title" autocomplete="off" value="<?php echo $user->logo_description; ?>" required>
                </div> -->
                <div class="form-group col-md-6">
