...
include "connect.php";
$id = $_GET['journal_id'];
$sql = "select * from articals where journal_id='$id' and status_type='current_issue' limit 0,6";
                        ...
                        <div class="issue-section" style="box-shadow: 0 5px 25px rgba(0, 0, 0, 0.1);; padding: 20px">
                            <div class="row">
                                ...
                                <div class=" col-lg-6 left-side">
                                    ...
                                    <h5><a href="articles/<?php echo $id; ?>/<?php echo $row['artical_id']; ?>/<?php echo $ar; ?>"><?php echo $row['artical_name']; ?></a></h5>
