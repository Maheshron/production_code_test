<?php include "main.php";
    ...
    if(isset($_POST['ArticleInPress'])){
      $ai = 2;
       ...
       $user->update_issue($artical_id,$ai);
    }
...
<body class="animsition ">
  ...
  <div class="card">
    ...
    <div id="<?php echo $a; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
       <?php 
            //   $one = 1;
       ...
       <div class="accordion">
        ...
        <?php foreach($arri as $b):
          ...
          <div class="card">
    <div class="card-header bgcolor-2" id="headingOne">
      <h2 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne<?php echo $b."r".$r; ?>" aria-expanded="true" aria-controls="collapseOne">
           Issue :<?php echo $b; ?>
        </button>
      </h2>
    </div>

    <div id="collapseOne<?php echo $b."r".$r; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
      <?php
           $sql5  = "select * from articals where volume_number = $a and journal_id = $id and issue_number = $b";
           $result5 = mysqli_query($user->db,$sql5);
       ...
       <table class="table table-hover table-bordered dataTable  w-full" id="exampleTableSearch">
            ...
            <tr data-position=<?php echo $row['Position']; ?> data-index=<?php echo $row['artical_id'] ?>>
                 ...
                 <form action="" method="post">
                      <button type="submit" class="btn btn-primary mt-2 fixbtn"  name="ArticleinPress"   value=" <?php echo  $row['artical_id']; ?>"      title="Edit" > Move To Article In Press</button>
