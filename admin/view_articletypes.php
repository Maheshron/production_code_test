...
<body class="animsition ">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Artical Types</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
        <li class="breadcrumb-item active">Artical Types</li>
      </ol>
      <div class="page-header-actions">
        <a class="btn btn-primary btn-outline  btn-sm" href="add_articaltype.php">
        <i class="icon wb-plus" aria-hidden="true"></i>
        <span class="hidden-sm-down"><b>Add Artical Types</b></span>
      </a>
      </div>
    </div>
    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading mb-3">
          <h3 class="panel-title text-center">Artical Types List</h3>
        </header>
