...
<?php include("sidebar.php"); ?>
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Add SEO Pages</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0)">SEO Pages</a></li>
        <li class="breadcrumb-item active">Add SEO Pages</li>
      </ol>
        ...
        <div class="panel-body container-fluid">
            ...
            <div class="row">
                 <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="url" autocomplete="off" required>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">JOURNAL ID</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="journalid" autocomplete="off" required>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName"> Title</label>
                         <textarea id="summernote" data-plugin="summernote"   name="title" required></textarea>
                       
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Description</label>
                       <textarea id="summernote1" data-plugin="summernote"   name="description" required></textarea>
                </div>
               <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Keywords</label>
                    
                       <textarea id="summernote2" data-plugin="summernote"   name="keywords" required></textarea>
                       
                </div>
               
                    
                <div class="form-group col-md-12 text-center">
                      <button type="submit" name="submit" class="btn btn-primary">Add SEO Pages</button>
                </div>
...
<?php 
    ...
    if(isset($_REQUEST['submit'])){
      extract($_REQUEST);
             ...
             $result=$user->add_SEOPages($url,$journalid,$title,$description,$keywords);
        if($result){
          echo '<script> setTimeout(function () { swal("Success ! ","SEO Pages Added Successfully","success");}, 2000); </script>';
        }else{
