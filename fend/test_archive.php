...
<body>
    ...
    <div id="main-wrapper">
        ...
        <!--Arcive Area Start-->
        <div class="arcive-area section  pt-30 pt-lg-75 pt-md-65 pt-sm-55 pt-xs-45 pb-80 pb-lg-60 pb-md-50 pb-sm-40 pb-xs-30 mt-lg-80 mt-md-70 mt-sm-60">
                                ...
                                <div class="code-preview">
                                    <div class="accordion" id="accordionExample">
                                       <?php foreach($arr as $a): ?>
                                        <div class="card">
                                            <div class="card-header" data-toggle="collapse" data-target="#collapseOne<?php echo $a; ?>" aria-expanded="true" aria-controls="collapseOne" id="headingOne">
                                                <h5 class="mb-0">
                                                    <a class="" data-toggle="collapse" data-target="#collapseOne<?php echo $a;?>" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-calendar" aria-hidden="true"></i> 
                                                        Volume <?php echo $a; ?>
                                                        
                                                    </a>
                                                    <a class="" style="float: right; font-size: 18px;" data-toggle="collapse" data-target="#collapseOne<?php echo $a; ?>" aria-expanded="true" aria-controls="collapseOne">
                                                        <span ><i style=" font-size: 26px;" class="fa fa-angle-down" aria-hidden="true"></i></span>
                                            ...
                                            <div id="collapseOne<?php echo $a; ?>" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
                                                <div class="card-body">
