...
<body class="animsition ">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">SEO Pages</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
        <li class="breadcrumb-item active">SEO Pages</li>
      </ol>
      <div class="page-header-actions">
        <a class="btn btn-primary btn-outline  btn-sm" href="add_seopages_innersidebar.php?journal_id=<?php echo $journal_id;  ?>">
        <i class="icon wb-plus" aria-hidden="true"></i>
        <span class="hidden-sm-down"><b>Add SEO Pages</b></span>
      </a>
      </div>
    </div>
    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading mb-3">
          <h3 class="panel-title text-center">SEO Pages List</h3>
        </header>
        <div class="panel-body">
          <table class="table table-hover table-bordered dataTable  w-full" id="exampleTableSearch">
            ...
            <tbody>
                         <?php     $user->get_innerside_SEOPageslist($journal_id); ?>
