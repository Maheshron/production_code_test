                                       ...
                                       <?php foreach($arr as $a): ?>
                                            ...
                                            <div id="collapseOne" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <div class=" archive-issue" >
                                                        ...
                                                        <p>(July 2019)</p>
                                                        <h5><a href="article.html">Volume 12, Issue 3 </a> </h5>
                                                        <p>(Augast 2019)</p>
                                        ...
                                        <!-- <div class="card">
                                            ...
                                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                                <div class="card-body">
                                                    <div class=" archive-issue" >
                                                        <h5> <a href="#">Volume 12, Issue 6 </a></h5>
                                                        <p></p>
                                                        <h5><a href="#">Volume 12, Issue 5 </a> </h5>
                                                        <p></p>
                                                        <h5><a href="#">Volume 12, Issue 4 </a> </h5>
                                                        <p></p>
                                                        <h5><a href="#">Volume 12, Issue 3 </a> </h5>
                                                        <p></p>
                                                        <h5><a href="#">Volume 12, Issue 2 </a></h5>
                                                        <p></p>
                                                        <h5><a href="#">Volume 12, Issue 1 </a> </h5>
                                                        <p></p>
                                                    </div>
                                                </div>
                                            </div>
