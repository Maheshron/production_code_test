...
<body class="animsition ">
  ...
  <div class="card">
    <div class="card-header" id="headingOne">
      <h2 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#<?php echo $a; ?>" aria-expanded="true" aria-controls="collapseOne">
        Volume_Number  <?php echo $a; ?>
        </button>
        
      </h2>
    </div>

    <div id="<?php echo $a ;?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
                  <?php  ?>
                 <?php  $sql2 = "select * from articals where volume_number = $a and status_type='ArticleInPress'"; 
            ...
            <tr>
                 ...
                 <td>
                     <b> Issue <?php echo $row['issue_number']; ?></b><br>
