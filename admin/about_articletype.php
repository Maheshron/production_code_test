...
if (isset($_REQUEST['articletypeslist_id'])) {
        extract($_REQUEST);
	    $user->get_articletypesdetails($articletypeslist_id);
}
if(isset($_REQUEST['submit'])){
  $id = $_GET['articletypeslist_id'];
  $updatedartical_name = $_POST['articalname'];
  $result = $user->update_articaltypelist($id,$updatedartical_name);
  if($result){
...
<?php include("sidebar.php"); ?>
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">About Article Type</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0)">Article Type</a></li>
        <li class="breadcrumb-item active">About Article Type</li>
      </ol>
        ...
        <div class="panel-body container-fluid">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="articalname" value="<?php echo $user->articlelisttype_data ?>" autocomplete="off">
                             
                </div>
              
                    
                <div class="form-group col-md-12 text-center">
                      <button type="submit" name="submit" class="btn btn-primary">Save Article Type</button>
                </div>
            </div>
        </div>
      </div>
