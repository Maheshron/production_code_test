...
$id = $_GET['journal_id'];
$eid = $_GET['editor_id'];
$sql = "select * from editors where editor_id='$eid'";
            ...
            <nav class="nav dark-nav">
                <div class="container">
                    ...
                    <div class="menu" id="open-navbar1">
                        <ul class="list">
                            <li><a href="journal.php?journal_id=<?php echo $id; ?>">Home</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="info">
                                    ...
                                    <p>Director, Cardiac Electrophysiology Laboratory<br>
                                       <?php echo $data['designation']; ?><br>
                                ...
                                <div class="bio">
                                    <h3><b>Biography</b></h3>
                                    <hr>
                                    <p> <?php echo $data['biography']; ?></p><br>
                                    <h3><b>Research Interest</b></h3>
                                    <hr>
                        <p>              <?php echo $data['research_interest']; ?></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="sticky-sidebar" class="col-lg-3">
                        <div class="keywords-sec">
                            ...
                            <div class="single-sidebar-widget mb-30 mb-xs-20">
                                <h4>Keywords</h4>
                                <ul>
                                    <?php $sql2 ="select * from keywords where journal_id='$id' limit 0,14";
                                    $result2 = mysqli_query($con,$sql2);
                                    while($row2 = mysqli_fetch_array($result2)){ ?>
                                    <li><a href="#"><i class="fa fa-file-text-o"></i> <?php echo $row2['keyword']; ?></a></li>
                                    <?php } ?>
...
-->
                                    <li><a class="view-more" href="keywords.php?journal_id=<?php echo $id; ?>">View more <i class="icofont-long-arrow-right"></i></a></li>
                                </ul>
                            </div>
