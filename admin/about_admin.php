  ...
  <div class="page">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">About Admin</li>
      </ol>
    ...
    <div class="page-content">
      ...
      <div class="panel">
        <div class="panel-body container-fluid">
              <form method="post" action="" name="aboutadmin">
            <div class="row">
               
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">User Name</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="username" autocomplete="off" value="<?php echo $a_name; ?>">
                </div>
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Password</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="password" autocomplete="off" value="<?php echo $a_password; ?>">
                </div>
                
                <div class="form-group col-md-12 text-center">
                      <button onclick="return(submitAbout());" type="submit" name="submit" class="btn btn-primary">Save</button>
                </div>
...
if (isset($_REQUEST['submit'])) {
		 extract($_REQUEST);
	    $register = $user->update_admin($admin_id,$username,$password);
	    if ($register) {
