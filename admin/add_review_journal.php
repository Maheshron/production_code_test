...
if(isset($_REQUEST['submit'])){
    extract($_REQUEST);
    $result = $user->add_review($journal_id,$name,$uname,$rdesignation,$country,$email,$description);
    if($result){
        echo '<script> setTimeout(function () { swal("Success ! ","Added Successfully","success");}, 2000); </script>';
        }else{
          ...
          <div class="row row-lg">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="name" id="inputBasicFirstName" autocomplete="off">
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">University Name</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="uname" autocomplete="off">
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Reviewer Designation</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="rdesignation" autocomplete="off">
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="email" autocomplete="off">
                </div>
               <div class="form-group col-md-12">
