    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading mb-3">
          <h3 class="panel-title text-center">Subscribers List</h3>
        </header>
          ...
          <table class="table table-hover table-bordered dataTable  w-full" >
            <thead>
              <tr>
                ...
                <th class="text-center">Life Science</th>
                <th class="text-center">Health Science</th>
                <th class="text-center">Chemical Science</th>
...
<!--                <th class="text-center" width="5%">Edit</th>-->
            ...
            <tbody>
                ...
                $sql = "select * from subscribe where email_verification=1 order by id desc";
          $result= mysqli_query($user->db,$sql);
          while($data = mysqli_fetch_array($result)){ 
             $life_science=$data['life_science'];
              $health_science=$data['health_science'];
              $chemical_science=$data['chemical_science'];
              $email_verification=$data['email_verification'];
              $date = $data['subscribe_time'];
              $day =  DateTime::createFromFormat("Y-m-d H:i:s", $date)->format("d/m/Y");
            ...
            <tr>
                ...
                <td ><?php if($life_science==0){echo "No"; }else{ echo "Yes"; }?></td>
                <td><?php if($health_science==0){echo "No"; }else{ echo "Yes"; }?></td>
                <td><?php if($chemical_science==0){echo "No"; }else{ echo "Yes"; }?></td>
                <td><?php if($email_verification==0){?><span style="color:red;font-weight:bold">Not Verified</span> <?php }else{ ?><span style="color:green;font-weight:bold">Verified</span><?php } ?></td>
                 <td><?php echo $day; ?></td>
                 <td><?php echo $time; ?></td>
...
-->
            ...
            <?php
               ...
               <?php 
                ...
                $sql = "select * from subscribe where email_verification=0 order by id desc";
          $result= mysqli_query($user->db,$sql);
          while($data = mysqli_fetch_array($result)){ 
             $life_science=$data['life_science'];
              $health_science=$data['health_science'];
...
-->
                 <td class="text-center">
                     <a href="delete.php?subscribe_id=<?php echo $data['id']; ?>" title="Delete"><i class="fa fa-trash-o"></i></a>
                 </td>
              </tr>
            <?php
          } 
