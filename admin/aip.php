...
<body class="animsition ">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Articles In Press</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
        <li class="breadcrumb-item active">Articles In Press</li>
      </ol>
    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading mb-3">
          <h3 class="panel-title text-center">Article In Press</h3>
        </header>
