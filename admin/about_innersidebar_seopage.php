...
if (isset($_REQUEST['journal_id'])) {
        extract($_REQUEST);
	    $user->get_innersidebar_SEOPagesdata($journal_id);
}
$id= $_GET['journal_id'];
if(isset($_REQUEST['submit'])){
  extract($_REQUEST);
              $result = $user->update_innersidebar_SEOPages($id,$url,$title,$description,$keywords);
    if($result){
     ...
     <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row">
                 <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="url" autocomplete="off" value="<?php echo $user->seourl1; ?>" required>
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName"> Title</label>
                         <textarea id="summernote" data-plugin="summernote"   name="title" required><?php echo $user->seotitle1; ?></textarea>
                       
                </div>
                <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Description</label>
                       <textarea id="summernote" data-plugin="summernote"   name="description" required><?php echo $user->seodescription1; ?></textarea>
                </div>
               <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Keywords</label>
                    
                       <textarea id="summernote" data-plugin="summernote"   name="keywords"  required><?php echo $user->seokeywords1; ?></textarea>
