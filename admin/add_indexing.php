...
<?php include("sidebar.php"); ?>
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Add Indexing</h1>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index-2.html">Home</a></li>
        <li class="breadcrumb-item"><a href="javascript:void(0)">Indexing</a></li>
        <li class="breadcrumb-item active">Add Indexing</li>
      </ol>
          ...
          <div class="row row-lg">
            ...
            <div class="col-xl-4 col-md-6">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <input type="file" id="input-file-now" name="img_name" data-plugin="dropify" data-default-file="../edelweiss/upload/upload.png"/>
                </div>
              </div>
              <!-- End Example Default -->
            </div>
            ...
            <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Index Logo Alternative Image Text</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="indexalttext" autocomplete="off" required>
                </div>
                <!-- <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Indexed Title</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="indexlogo_title" autocomplete="off" required>
                </div> -->
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Indexed Link</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="indexlogo_link" autocomplete="off" required>
                </div>
               <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Logo Description </label>
                    
                       <textarea id="summernote"   name="indexlogo_description"></textarea>
                       
                </div>
               
                    
                <div class="form-group col-md-12 text-center">
                      <button type="submit" name="submit" class="btn btn-primary">Add Indexing</button>
                </div>
...
<?php 
    ...
    if(isset($_REQUEST['submit'])){
      extract($_REQUEST);
      $indexing_image= $_FILES['img_name']['name'];
      $temp_indexing_image= $_FILES['img_name']['tmp_name'];
       ...
       $indexing_image_extension=pathinfo($indexing_image,PATHINFO_EXTENSION);
          if(!in_array($indexing_image_extension,$allowed)){
                  echo "<script> alert('Your Image File Extension Is Not Supported.'); </script>";
                  $indexing_image="";
          }
        
              move_uploaded_file($temp_indexing_image,"../edelweiss/upload/indexes/$indexing_image");
             $result=$user->add_indexing($indexing_image,$indexlogo_link,$indexlogo_description,$indexalttext);
        if($result){
          echo '<script> setTimeout(function () { swal("Success ! ","Indexing Added Successfully","success");}, 2000); </script>';
        }else{
