...
if(isset($_POST['update'])){
  ...
  foreach($_POST['positions'] as $position){
    ...
    $query = "update editors set Position = '$newPosition' where editor_id = '$index'";
    ...
    <div class="page-content">
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          <table class="table table-hover table-bordered   w-full" id="exampleTableSearch">
            <thead>
              <tr>
              <th>Id</th>
                <th>Name</th>
