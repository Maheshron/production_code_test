...
include "connect.php";
$id = $_GET['journal_id'];
$sql = "select * from articals where journal_id='$id' and status_type='article_in_press' limit 0,6";
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="sub-navbar">
          ...
          <!-- <li><a href="article-in-press.php?artical_id=">Articles in Press</a></li> -->
                        ...
                        <!-- <div class="issue-section" style="box-shadow: 0 5px 25px rgba(0, 0, 0, 0.1);; padding: 20px">
                            <div class="row">
                                ...
                                <div class=" col-lg-6 left-side">
                                    ...
                                    <P class="name">Sheref M Zaghloul, Walid Hassan*, Ashraf M Reda, Ghada M Sultan, Mohamed A Salah, Hassan O Balubid, Safia Inamurrahim, Khalid Tammam, Ahmad Zaatar, Mohammed S Gassar</P>
                                    <div class="Links-box">
                                        <a  href="article.html" class="btn btn-primary">Full Text</a>
                                        <a class="pdf-btn" href="http://edelweisspublications.com/edelweiss/article/ct-coronary-angiography-versus-coronary-angiography-detect-specificity-sensitivity-ct-coronary-2639-6807-cccm-18-119.pdf" target="_blank"><img src="assets/images/PDF_32.png">Download PDF</a>
                                    </div>
                                </div>
                                <div class="col-lg-6 right-side">
                                    <h4>Abstract</h4>
                                    ...
                                    <a style="float: right" class="view-more" href="keywords.html">View more <i class="icofont-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div> -->
                        <!-- <div class="issue-section" style="box-shadow: 0 5px 25px rgba(0, 0, 0, 0.1);; padding: 20px">
