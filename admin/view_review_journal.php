  ...
  <div class="page">
    <div class="page-header">
      ...
      <div class="page-header-actions">
        <a class="btn btn-primary btn-outline  btn-sm" href="add_review_journal.php?journal_id=<?php echo $journal_id; ?>">
        <i class="icon wb-plus" aria-hidden="true"></i>
        <span class="hidden-sm-down"><b>Add Review</b></span>
      </a>
      </div>
    </div>
    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading mb-3">
          <h3 class="panel-title text-center">Reviewers List</h3>
        </header>
        <div class="panel-body">
          <table class="table table-hover table-bordered dataTable  w-full" id="exampleTableSearch">
            ...
            <tbody>
                 ...
                 <?php $user->getjournal_reviews($journal_id); ?>
