...
<body class="animsition app-projects">
  ...
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">Journal Categories</h1>
          ...
          <li>
            <div class="panel">
              <figure class="overlay overlay-hover animation-hover">
                 <div  title="Journal Title" style="height:60px;font-size:15px"><b><?php echo $row['cat_title']; ?> Science</b></div>
                <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align animation-hover">
                  ...
                  <a href="sub_categories.php?categories=<?php echo $row['cat_id']; ?>" class="btn btn-outline btn-default project-button" title="View Journal"><i class="icon wb-eye" aria-hidden="true" ></i> Go</a>
                </figcaption>
              </figure>
...
<!--               
          <li>
            <div class="panel">
              <figure class="overlay overlay-hover animation-hover">
                 <div  title="Journal Title" style="height:60px;font-size:15px"><b>Health Science</b></div>
                <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align animation-hover">
                  <div class="btn-group">
                  ...
                  <a href="sub_categories.php?categories=health" class="btn btn-outline btn-default project-button" title="View Journal"><i class="icon wb-eye" aria-hidden="true" ></i> Go</a>
                </figcaption>
              </figure>
...
<!--                
            ...
            <div class="panel">
              <figure class="overlay overlay-hover animation-hover">
                ...
                <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align animation-hover">
                  ...
                  <a href="sub_categories.php?categories=applied" class="btn btn-outline btn-default project-button" title="View Journal"><i class="icon wb-eye" aria-hidden="true" ></i> Go</a>
                </figcaption>
              </figure>
          ...
          <!-- <li>
            <div class="panel">
              <figure class="overlay overlay-hover animation-hover">
                 <div  title="Journal Title" style="height:60px;font-size:15px"><b>Chemical Science</b></div>
                <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align animation-hover">
                  <div class="btn-group">
                  ...
                  <a href="sub_categories.php?categories=chemical" class="btn btn-outline btn-default project-button" title="View Journal"><i class="icon wb-eye" aria-hidden="true" ></i> Go</a>
                </figcaption>
              </figure>
