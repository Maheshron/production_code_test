...
<body class="animsition app-projects">
  ...
  <div class="page">
    <div class="page-header">
      ...
      <a class="btn btn-primary btn-outline  btn-sm" href="add_journal.php">
        <i class="icon wb-plus" aria-hidden="true"></i>
        <span class="hidden-sm-down"><b>Add Journal</b></span>
      </a>
      ...
      <div class="projects-wrap">
        <ul class="blocks blocks-100 blocks-xxl-5 blocks-lg-4 blocks-md-3 blocks-sm-2"
          data-plugin="animateList" data-child=">li">
           ...
           if(isset($_GET['categorie']) && isset($_GET['sub_categorie'])){

           
           $user->get_journallist($categorie,$sub_categorie); 
         }
         else{
           $user->get_journallist1();
         }
         ?>
        </ul>
      </div>
